...
# model trả về vector 512 chiều
model = InceptionResnetV1(
    classify=False,             # đảm bảo đầu ra sẽ là 1 Feature Vector
    pretrained="casia-webface"
).to(device)

model.eval()                    # khai báo cho PyTorch rằng mình đang evaluation, không phải training
